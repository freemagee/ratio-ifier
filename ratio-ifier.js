   ...
   'use strict';
    ...
    var view = {
        ...
        render: function() {
            ...
            this.DOM.calculateBtn.addEventListener('click', function() {
            ...
            this.DOM.recalculateBtn.addEventListener('click', function() {
                controller.recalculateDimensions(_this.resultWidth.dataset.value, _this.resultHeight.dataset.value);
            });
            this.DOM.resultWidth.addEventListener('change', function() {
                this.dataset.value = this.value;
            });
            this.DOM.resultHeight.addEventListener('change', function() {
                this.dataset.value = this.value;
            });
        },
